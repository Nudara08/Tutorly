...
struct CardStackView: View {
    @State var profiles = [
        Profile(id: 0, name: "Albert Deran", image: "albert-dera-ILip77SbmOE-unsplash", subject: "English", offset: 0),
        Profile(id: 1, name: "Chloe Alexis", image: "alexis-chloe-TYDkKEgc0Fg-unsplash", subject: "English", offset: 0),
        Profile(id: 2, name: "Gabriel Silverio", image: "gabriel-silverio-u3WmDyKGsrY-unsplash", subject: "Maths", offset: 0),
        Profile(id: 3, name: "Joseph Gonzalez", image: "joseph-gonzalez-iFgRcqHznqg-unsplash", subject: "Art", offset: 0),
...
class Profile: Identifiable {
    ...
    init(id: Int, name: String, image: String, subject: String, offset: CGFloat = 0) {
        self.id = id
        self.name = name
        self.image = image
